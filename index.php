...
<div class="formgroup" id="message-form">
    <textarea id="message" name="pesan" placeholder="Pesan/Kesan" required></textarea>
</div>
    <br>
    ...
    <table border="0" align="center" width="800px">
        <tr>
        <td colspan="5" id="specialtext" colspan="5" ><center><div class="kepuasan">Kepuasan</div></center></td>
        </tr>
    <tr align="center">
...
<div class="test" id="page2" style="padding-bottom:  100px;">
    <div id="piechart" style="width: 1400px; height: 500px;" class="pages"><a href="#top">Isi Buku Tamu</a></div>
     <div class="link"><a href="#top" id="link2"><center>Isi Buku Tamu</center></a></div>
...
if(isset($_POST["happy"])){  
        ...
        $kepuasan = "Senang";
        $sql = mysqli_query($con,"INSERT INTO data_user(id_user,nama,alamat,pesan,kepuasan,tgl,jam) VALUES (null, '$nama', '$alamat', '$pesan', '$kepuasan', '$tgl', '$jam') ") or die ("error");
if($sql){
    
    echo '<script>
           
        swal("Terima Kasih!", "Pesan Anda Telah Terupload", "success");
